...
/** \mainpage RoboComp::obstacle_avoiding
 *
 * \section intro_sec Introduction
 *
 * The obstacle_avoiding component...
 *
 ...
 *
 * Just: "${PATH_TO_BINARY}/obstacle_avoiding --Ice.Config=${PATH_TO_CONFIG_FILE}"
 *
...
class obstacle_avoiding : public RoboComp::Application
{
public:
	obstacle_avoiding (QString prfx, bool startup_check) { prefix = prfx.toStdString(); this->startup_check_flag=startup_check; }
private:
	void initialize();
	std::string prefix;
	MapPrx mprx;
...
void ::obstacle_avoiding::initialize()
{
...
int ::obstacle_avoiding::run(int argc, char* argv[])
{
#ifdef USE_QTGUI
...
int main(int argc, char* argv[])
{
	...
	::obstacle_avoiding app(prefix, startup_check_flag);
