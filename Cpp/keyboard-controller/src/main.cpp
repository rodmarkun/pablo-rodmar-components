...
/** \mainpage RoboComp::keyboard_controller
 *
 * \section intro_sec Introduction
 *
 * The keyboard_controller component...
 *
 ...
 *
 * Just: "${PATH_TO_BINARY}/keyboard_controller --Ice.Config=${PATH_TO_CONFIG_FILE}"
 *
...
class keyboard_controller : public RoboComp::Application
{
public:
	keyboard_controller (QString prfx, bool startup_check) { prefix = prfx.toStdString(); this->startup_check_flag=startup_check; }
private:
	void initialize();
	std::string prefix;
	MapPrx mprx;
...
void ::keyboard_controller::initialize()
{
...
int ::keyboard_controller::run(int argc, char* argv[])
{
#ifdef USE_QTGUI
...
int main(int argc, char* argv[])
{
	...
	::keyboard_controller app(prefix, startup_check_flag);
